...
static int set_rf_id(char *str)
{
        ...
        {
            printk("Kernel RF SKU = US SKU\n");
        }
        else if ( strcmp("3", str) == 0 )
        {
            printk("Kernel RF SKU = RF_SKU_UNKNOWN\n");
        }

        printk("androidboot.id.rf = %s\n", str);
        return 0;
}
...
static int set_hardware_id(char *str)
{
        ...
        {
                g_ASUS_hwID = HW_REV_MP;
                printk("Kernel HW ID = ZZS673KS_MP\n");
        }
